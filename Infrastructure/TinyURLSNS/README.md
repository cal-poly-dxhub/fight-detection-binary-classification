...
```bash
TinyURLSNS$ sam logs -n HelloEfsFunction --stack-name TinyURLSNS --tail
```
...
```bash
TinyURLSNS$ pip install -r tests/requirements.txt --user
# unit test
TinyURLSNS$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
TinyURLSNS$ AWS_SAM_STACK_NAME=<stack-name> python -m pytest tests/integration -v
```
...
```bash
aws cloudformation delete-stack --stack-name TinyURLSNS
```

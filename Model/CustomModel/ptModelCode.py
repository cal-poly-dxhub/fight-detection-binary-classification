...
def create_model(n_classes):
    ...
    #model = torch.hub.load("pytorch/vision", "efficientnet_v2_l")
    #model = torch.hub.load("pytorch/vision", "efficientnet_b7")
...
# 1) remove std and resize
# 2) try efficientnet_v2_l 
# 3) Unfreeze layer and try resizing, currently only unfreezing last 2 layers
    mean_nums = [0.485, 0.456, 0.406]
    std_nums = [0.229, 0.224, 0.225]

    transforms = {'train': T.Compose([
        T.CenterCrop(size=1536),
        T.Resize(size=512),

...
def convert_to_mp4(input_file_name):
    ...
    try:
        ...
        mp4_file_path = INPUT_DIRECTORY + input_file_name.lower().replace(_format, ".mp4")
        subprocess.call(['ffmpeg', '-i', INPUT_DIRECTORY + input_file_name, mp4_file_path])
